...
• Get [Infinix](https://discord.com/api/oauth2/authorize?client_id=934760667234336798&permissions=8&scope=bot) | Support Soon | Vote Soon**
**
<:reply3:1003377442553081887> Modules
 ...
 <:reply:1003377407144759347><:Flantic_oki_oki:1039940119072866346>  : AutoResponder** """ , title='Infinix Help Menu.')
        ...
        embed.set_thumbnail(url="https://cdn.discordapp.com/avatars/934760667234336798/498b57c6a13ef39922e4dd2130bbcf04.png?size=1024")
        embed.set_author(name="infinix Commands", url="https://discord.gg/7srHc2aqQk", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
        embed.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
    ...
    ```''')
                ...
                feembedd.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                eembedd.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                membedd.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                w.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                b.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                btng.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                clem.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
                ...
                eclem.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
    ...
    async def fun(self , ctx):
        ...
        fembedd.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
    ...
    async def badge(self,ctx):
        ...
        bb.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
...
#  ------------------------
    ...
    async def games(self,ctx):
        ...
        btnn.set_footer(text="Infinix • Page 1/1", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
    ...
    #     btnn.set_footer(text="Made With `💖` By Team Alpha", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
    #     await ctx.send(embed=btnn)
...
#  ------------------------
    ...
    async def calculator(self,ctx):
        ...
        clem.set_footer(text="Infinix • Page 1/1", icon_url="https://cdn.discordapp.com/avatars/638073011236372480/49cf9dfd06e02aa93b1a829f85002c1d.png?size=256")
